  ...
  return (
    <div className="bg-white min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          <h2 className="text-3xl font-sans text-stone-900 mb-6">A Personalized Approach</h2>
          ...
          <ul className="space-y-4">
            {[
              ...
              <li key={i} className="flex items-center text-stone-800 font-medium">
                <CheckCircle2 className="text-[#96bb9b] mr-3" size={20} />
                {item}
              </li>
            ))}
          </ul>
      ...
      <section className="bg-[#2c2f62] text-white py-24">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-3 gap-12 text-center">
          <div className="flex flex-col items-center">
            <Heart className="text-[#96bb9b] mb-4" size={40} />
          ...
          <div className="flex flex-col items-center">
            <ShieldCheck className="text-[#96bb9b] mb-4" size={40} />
          ...
          <div className="flex flex-col items-center">
            <div className="w-10 h-10 border-2 border-[#96bb9b] rounded-full flex items-center justify-center mb-4 text-[#96bb9b] font-bold">1</div>
    ...
    <section className="relative w-full py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <h3 className="text-2xl font-sans text-stone-900">Ready to start your journey?</h3>
          ...
          <div className="flex w-full items-center justify-center">
            <Link 
              ...
              className="inline-block bg-[#4e8d58] text-white px-12 py-5 rounded-full hover:bg-stone-900 transition-all shadow-2xl text-center font-black uppercase tracking-widest active:scale-95 z-10"
            >
              Book Your Session
            </Link>
          </div>
